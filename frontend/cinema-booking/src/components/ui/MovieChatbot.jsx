...
export default function MovieChatbot() {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setTimeout(() => {
        addBotMessage({
          text: 'Xin chào! 👋 Tôi là trợ lý AI của CinemaBook.\n\nTôi có thể giúp bạn tư vấn phim, tìm thông tin lịch chiếu, và trả lời các câu hỏi về rạp. Bạn cần tôi giúp gì nào?',
        });
      }, 300);
    }
  }, [isOpen]);
  ...
  const handleUserInput = async (text) => {
    ...
    try {
      ...
      addBotMessage({ text: 'Xin lỗi, hệ thống AI đang bận hoặc gặp sự cố. Bạn vui lòng thử lại sau nhé.' });
    }
  };
